...
void adhoc()
{
    ...
    printf("\t\t\t3.Lift\n");
    printf("\t\t\t4.There are two types od burger\n");
    printf("\t\t\t5.Vasya and Book\n");
    printf("\t\t\t6.Game with string\n");
    printf("\t\t\t7.Return tracker shit menu\n");
...
void x3()
{
    ...
    int guest_uni[30];
    int count=0;
    printf("Enter the home Unifrom and Guest Unifrom: \n");
    for(int i=0;i<num;i++)
    {
